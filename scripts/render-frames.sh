...
make_png() {
    ...
    #fsleyes render --outfile $png_file --scene ortho --worldLoc 20.61959330240886 36.27085673014321 11.2251215764921 --displaySpace $nifti --xcentre  0.01661 -0.01234 --ycentre -0.07621 -0.02504 --zcentre -0.03193  0.07084 --xzoom 900.0 --yzoom 1200.0 --zzoom 850.0 --hideLabels --labelSize 14 --layout horizontal --hideCursor --bgColour 0.0 0.0 0.0 --fgColour 1.0 1.0 1.0 --cursorColour 0.0 1.0 0.0 --colourBarLocation top --colourBarLabelSide top-left --performance 3 $nifti --name $png_file_name --overlayType volume --alpha 100.0 --brightness 49.999999999993584 --contrast 50.0 --cmap greyscale --negativeCmap greyscale --displayRange 0.0 255.0 --clippingRange 0.0 285.0 --gamma 0.0 --cmapResolution 256 --interpolation none --numSteps 100 --blendFactor 0.1 --smoothing 0 --resolution 100 --numInnerSteps 10 --clipMode intersection --volume 0
    # For op (machine) NOTE!
    fsleyes_unfiltered render --outfile $png_file --scene ortho --worldLoc 20.61959330240886 36.27085673014321 11.2251215764921 --displaySpace $nifti --xcentre  0.01661 -0.01234 --ycentre -0.07621 -0.02504 --zcentre -0.03193  0.07084 --xzoom 900.0 --yzoom 1200.0 --zzoom 850.0 --hideLabels --labelSize 14 --layout horizontal --hideCursor --bgColour 0.0 0.0 0.0 --fgColour 1.0 1.0 1.0 --cursorColour 0.0 1.0 0.0 --colourBarLocation top --colourBarLabelSide top-left --performance 3 $nifti --name $png_file_name --overlayType volume --alpha 100.0 --brightness 49.999999999993584 --contrast 50.0 --cmap greyscale --negativeCmap greyscale --displayRange 0.0 255.0 --clippingRange 0.0 285.0 --gamma 0.0 --cmapResolution 256 --interpolation none --numSteps 100 --blendFactor 0.1 --smoothing 0 --resolution 100 --numInnerSteps 10 --clipMode intersection --volume 0
}
